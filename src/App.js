...
export default function App() {
  return (
    ...
    >
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-20 px-4 bg-black bg-opacity-60">
        <img
          src="/profile.jpg"
          alt="Shobhit Bansal"
      ...
      {/* About Me */}
      <section className="px-6 py-12 max-w-3xl mx-auto bg-black bg-opacity-70 rounded-md shadow-md">
        ...
        <p>
          ...
          With nearly two years of professional experience, I specialize in building clean, maintainable apps
          using Swift, UIKit, MVVM, and Core Data.
        </p>
        <p className="mt-4">
      ...
      {/* Timeline */}
      <section className="px-6 py-12 bg-black bg-opacity-70 max-w-3xl mx-auto rounded-md shadow-md">
      ...
      {/* Footer */}
      <footer className="text-center text-zinc-400 py-6 text-sm select-none">
